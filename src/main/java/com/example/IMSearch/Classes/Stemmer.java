package com.example.IMSearch.Classes;

/**
 * Classes.Stemmer, implementing the Porter Stemming Algorithm
 *
 * The Classes.Stemmer class transforms a word into its root form. The input word can be
...
public class Stemmer {
    ...
    /**
     * Stem the word placed into the Classes.Stemmer buffer through calls to add().
    ...
    /**
     * Test program for demonstrating the Classes.Stemmer. It reads text from a a list
     ...
     * must be done outside the Classes.Stemmer class. Usage: Classes.Stemmer file-name
     * file-name ...
     *
     * @throws Exception
     */
